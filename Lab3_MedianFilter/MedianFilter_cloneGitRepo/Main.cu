...
int main()
{
	...
	originalImage->Load("lena512.bmp");
	resultImageCPU->Load("lena512.bmp");
	resultImageGPU->Load("lena512.bmp");
	resultImageSharedGPU->Load("lena512.bmp");
	...
	resultImageCPU->Save("Lenna_cpu.bmp");
	resultImageGPU->Save("Lenna_gpu.bmp");
	resultImageSharedGPU->Save("Lenna_shared.bmp");
}